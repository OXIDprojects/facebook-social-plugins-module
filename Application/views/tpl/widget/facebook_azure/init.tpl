[{if $oViewConf->getFbAppId()}]
    ...
    [{oxscript include=$oViewConf->getModuleUrl('oefacebook','out/src/js/widgets/oxfacebook.js')}]
    [{if $oViewConf->isFacebookPluginActive('Confirm') && !$oViewConf->isFbWidgetVisible()}]
        <div id="fbinfo" class="fbInfoPopup popupBox corners FXgradGreyLight glowShadow">
            ...
            <div class="wrappingIntro clear">
                <h3>[{oxmultilang ident="OEFACEBOOK_ENABLE_INFOTEXTHEADER"}]</h3>
                [{oxifcontent ident="oefacebookenableinfotext" object="oCont"}]
